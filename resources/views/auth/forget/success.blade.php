...
<body class="gradient">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
        <div class="bg-white p-8 rounded-xl shadow-xl w-full max-w-lg">
            <h4 class="text-center text-xl font-bold text-gray-800 mb-4">ระบบจะส่งอีเมลถึงคุณเพื่อทำการ Reset Password
            </h4>
            <p class="text-center text-red-500 mb-2">หากไม่ได้รับอีเมล ให้ตรวจดูโฟลเดอร์จดหมายขยะ (Junk Email)</p>
            <p class="text-center text-gray-600 mb-6">อาจใช้เวลา 1-2 นาที *หากยังไม่ได้รับอีเมล์ กรุณาติดต่อ IT</p>
