...
<body>
    ...
    ">
            ...
            <div class='relative flex'>
              <div class='flex'>
                ...
                @if ($responseCode != 200)
                    ...
                    <img class="mb-3 w-24 h-24 rounded-full shadow-lg mt-8"
                        src="https://hr.vbeyond.co.th/imageUser/noImage.jpg" alt="" />
                @else
                    <div class="mb-3 rounded-full shadow-lg mt-8"
                        style="background-image: url('https://hr.vbeyond.co.th/imageUser/employee/{{ $data->img_check }}'); background-size: cover; width: 150px; height: 150px;">
                    </div>

                    {{-- <img class="mb-3 w-24 h-24 rounded-full shadow-lg mt-8" src="https://hr.vbeyond.co.th/imageUser/employee/{{$data->img_check}}"> --}}
                @endif
                <h5 class="mb-1 text-base font-semibold text-gray-900 lg:text-xl dark:text-white">{{ $data->name_th }}
                </h5>
        ...
        --}}
                <span
                    class="text-sm text-gray-500 dark:text-gray-400">{{ $data->position_ref->name ? $data->position_ref->name : '' }}</span>
                {{-- <span
          ...
          hover:shadow dark:bg-green-400 dark:hover:bg-green-400 dark:text-white">
            ...
            hover:shadow dark:bg-green-400 dark:hover:bg-green-400 dark:text-white">
              ...
              class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-emerald-900 bg-emerald-500 rounded dark:bg-emerald-900 dark:text-emerald-900">Connected</span> --}}
                    ...
                    @else
                        <li
                            class="flex items-center p-3 text-base font-bold text-gray-900 bg-red-200 rounded-lg hover:bg-red-400 group hover:shadow dark:bg-red dark:hover:bg-red-400 dark:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
